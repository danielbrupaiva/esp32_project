...
float mpu6050_get_accel_res(uint8_t accel_scale)
{
    ...
    switch (accel_scale) {
        case 0:accel_res = 2.0 / 32768.0;
            break;
        case 1:accel_res = 4.0 / 32768.0;
            break;
        case 2:accel_res = 8.0 / 32768.0;
            break;
        case 3:accel_res = 16.0 / 32768.0;
            break;
    }
...
float mpu6050_get_gyro_res(uint8_t gyro_scale)
{
    ...
    switch (gyro_scale) {
        case 0:gyro_res = 250.0 / 32768.0;
            break;
        case 1:gyro_res = 500.0 / 32768.0;
            break;
        case 2:gyro_res = 1000.0 / 32768.0;
            break;
        case 3:gyro_res = 2000.0 / 32768.0;
            break;
    }
